...
<body>
<a href="#edit-quantityUnit" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<!--g:form resource="${this.quantityUnit}" method="PUT"-->
    <g:form controller="operation4Physical" action="updateQuantityUnit">
        <g:hiddenField name="version" value="${this.quantityUnit?.version}"/>
        <g:hiddenField name="id" value="${this.quantityUnit?.id}"/>
        <fieldset class="form">
