...
<html>
    ...
    <body>
        <a href="#list-pipeNetwork" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="list-pipeNetwork" class="content scaffold-list" role="main">
            ...
            <div class="paginationGrails">
                <g:paginate total="${pipeNetworkCount ?: 0}" />
            </div>
        </div>
    </body>
</html>